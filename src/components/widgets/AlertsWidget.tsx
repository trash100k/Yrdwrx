...
export default function AlertsWidget({ isReel, flexOrder, alerts }: { isReel: boolean, flexOrder?: number, alerts?: { type: string, label: string, text: string, level: string }[] }) {
  // Always real: `alerts` is a computed feed of overdue billing + leads-to-follow-up.
  // No fabricated placeholder data — an empty feed simply renders the "all clear" state.

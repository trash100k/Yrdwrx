    ...
    <div
      ...
      className={`relative ${
        isReel
          ...
          : "bg-zinc-950 border border-white/5 rounded-2xl p-5 sm:p-8 col-span-1 shadow-2xl space-y-6 flex flex-col justify-between group h-full"
      }`}
    >
      <div className="flex justify-between items-start">
        <div className="space-y-1">
          <span className="text-xs md:text-[10px] bg-pink-500/20 text-pink-400 font-bold tracking-widest uppercase px-2.5 py-0.5 rounded-full inline-flex items-center gap-1.5">

        ...
        >
          ...
          >
            ...
            <div className="flex-1 max-w-2xl hidden lg:flex justify-start mr-auto lg:pr-12">
              <label htmlFor="system-search-button" className="sr-only">
                Search
              </label>
              <button
                id="system-search-button"
                type="button"
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-2 sm:gap-4 border-l border-white/10 pl-4 sm:pl-6">
                ...
                <button
                  ...
                  className="hidden xl:flex items-center gap-3 ml-4 cursor-pointer hover:bg-white/5 p-2 rounded-xl transition-colors text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-forest-500"

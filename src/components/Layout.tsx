        ...
        >
          <div className="flex-1 flex flex-col">
            ...
            <div className="mt-auto pt-8 border-t border-white/5 space-y-4">
              ...
              <Tooltip content="Toggle sidebar" position="top">
                <button
                  onClick={() => setIsSidebarOpen(!isSidebarOpen)}
                  aria-label="Toggle sidebar"
                  className="w-full flex items-center justify-center p-6 rounded-3xl bg-white/5 text-zinc-400 hover:text-white transition-all border border-white/5 focus:outline-none focus-visible:ring-2 focus-visible:ring-forest-500"
                >
                  <Menu size={24} />
                </button>
              </Tooltip>
              ...
              <div className="flex items-center gap-2 sm:gap-4 border-l border-white/10 pl-4 sm:pl-6">
                ...
                <Tooltip content="Quick Create" position="bottom">
                  <button
                    ...
                    className="w-10 h-10 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white hover:bg-white/10 flex items-center justify-center transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-forest-500"
                ...
                <Tooltip content="Notifications" position="bottom">
                  <button
                    ...
                    className="w-10 h-10 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white flex items-center justify-center transition-all relative focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                ...
                <Tooltip content="Get Help" position="bottom">
                  <button
                    ...
                    className="w-10 h-10 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white flex items-center justify-center transition-all relative focus:outline-none focus-visible:ring-2 focus-visible:ring-forest-500"
                    aria-label="Get Help"
                  >
                    <Brain size={20} />

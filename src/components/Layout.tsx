            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-2 sm:gap-4 border-l border-white/10 pl-4 sm:pl-6">
                ...
                <Tooltip content="Toggle Field Theme" position="bottom">
                  <button onClick={() => updateThemeSetting('visualContrast', themeSettings.visualContrast === 'outdoor-light' ? 'classic-obsidian' : 'outdoor-light')} className="min-w-11 min-h-11 w-11 h-11 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white hover:bg-white/10 flex items-center justify-center transition-all bg-amber-500/10 text-amber-500 border-amber-500/20 hover:bg-amber-500/20 hover:text-amber-400 focus-visible:ring-2 focus-visible:ring-forest-500 focus:outline-none" aria-label="Toggle Field Theme">
                    {themeSettings.visualContrast === 'outdoor-light' ? <Moon size={20} /> : <Sun size={20} />}
                  </button>
                </Tooltip>

                <Tooltip content="Quick Create" position="bottom">
                  <button onClick={() => setIsQuickCreateOpen(true)} className="min-w-11 min-h-11 w-11 h-11 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white hover:bg-white/10 flex items-center justify-center transition-all focus-visible:ring-2 focus-visible:ring-forest-500 focus:outline-none" aria-label="Quick Create">
                    <Plus size={20} />
                  </button>
                </Tooltip>

                <Tooltip content="Keyboard Shortcuts (?)" position="bottom">
                  <button onClick={() => setIsShortcutsOpen(true)} className="hidden sm:flex min-w-11 min-h-11 w-11 h-11 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white hover:bg-white/10 items-center justify-center transition-all focus-visible:ring-2 focus-visible:ring-forest-500 focus:outline-none" aria-label="Keyboard shortcuts">
                    <span className="text-base font-black leading-none">?</span>
                  </button>
                </Tooltip>

                <Tooltip content="Notifications" position="bottom">
                  <button onClick={() => setIsNotificationsOpen(true)} className="min-w-11 min-h-11 w-11 h-11 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white flex items-center justify-center transition-all relative focus-visible:ring-2 focus-visible:ring-forest-500 focus:outline-none" aria-label="Notifications">
                    <Bell size={20} />
                    {unreadNotifications > 0 && <span className="absolute top-2 right-2 w-2.5 h-2.5 bg-blue-500 rounded-full border-2 border-black" />}
                  </button>
                </Tooltip>

                <Tooltip content="Get Help" position="bottom">
                  <button id="brain-trigger" onClick={() => setIsBrainOpen(true)} className="min-w-11 min-h-11 w-11 h-11 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white flex items-center justify-center transition-all relative focus-visible:ring-2 focus-visible:ring-forest-500 focus:outline-none" aria-label="Get Help">
                    <Brain size={20} />
                  </button>
                </Tooltip>

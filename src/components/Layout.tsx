          ...
          >
            ...
            <div className="flex-1 max-w-2xl hidden lg:flex justify-start mr-auto lg:pr-12">
              ...
              >
                ...
                <div
                  className="w-full pl-16 pr-8 py-4 bg-white/5 border border-white/5 rounded-2xl text-lg font-bold hover:bg-white/10 hover:border-forest-500/30 transition-all text-zinc-500 flex items-center justify-between text-left"
                >

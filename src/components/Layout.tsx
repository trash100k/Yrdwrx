          ...
          >
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-2 sm:gap-4 border-l border-white/10 pl-4 sm:pl-6">
                ...
                <Tooltip position="bottom" content={themeSettings.visualContrast === 'outdoor-light' ? "Switch to Dark Mode" : "Switch to Outdoor Light Mode"}>
                  <button
                    onClick={() => {
                ...
                <Tooltip position="bottom" content="Get Help (YardPilot AI)">
                  <button
                    id="brain-trigger"

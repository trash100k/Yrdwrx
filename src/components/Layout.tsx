          ...
          >
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-2 sm:gap-4 border-l border-white/10 pl-4 sm:pl-6">
                ...
                <Tooltip position="bottom" content="Toggle Field Theme">
                  <button
                ...
                <Tooltip position="bottom" content="Quick Create">
                  <button
                    onClick={() => setIsQuickCreateOpen(true)}
                    className="min-w-11 min-h-11 w-11 h-11 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white hover:bg-white/10 flex items-center justify-center transition-all focus-visible:ring-2 focus-visible:ring-forest-500 focus:outline-none"
                ...
                <Tooltip position="bottom" content="Keyboard Shortcuts">
                  <button
                    ...
                    className="hidden sm:flex min-w-11 min-h-11 w-11 h-11 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white hover:bg-white/10 items-center justify-center transition-all focus-visible:ring-2 focus-visible:ring-forest-500 focus:outline-none"
                ...
                <Tooltip position="bottom" content="Notifications">
                  <button
                    ...
                    className="min-w-11 min-h-11 w-11 h-11 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white flex items-center justify-center transition-all relative focus-visible:ring-2 focus-visible:ring-forest-500 focus:outline-none"
                ...
                <Tooltip position="bottom" content="Get Help">
                  <button
                    id="brain-trigger"

                ...
                <div className="hidden sm:block">
                  <Tooltip content="Keyboard shortcuts">
                    <button
                      ...
                      className="flex min-w-11 min-h-11 w-11 h-11 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white hover:bg-white/10 items-center justify-center transition-all"

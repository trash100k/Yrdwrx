          ...
          >
            ...
            <div className="flex-1 max-w-2xl hidden lg:flex justify-start mr-auto lg:pr-12">
              <button
                type="button"
                id="system-search"
                className="relative group w-full cursor-pointer focus-visible:ring-2 focus-visible:ring-forest-500 outline-none rounded-2xl"
              ...
              <div className="flex items-center gap-2 sm:gap-4 border-l border-white/10 pl-4 sm:pl-6">
                ...
                <Tooltip content="Quick Create">
                  <button
                    ...
                    className="w-10 h-10 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white hover:bg-white/10 flex items-center justify-center transition-all focus-visible:ring-2 focus-visible:ring-forest-500 outline-none"
                ...
                <Tooltip content="Keyboard shortcuts">
                  <button
                    ...
                    className="hidden sm:flex w-10 h-10 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white hover:bg-white/10 items-center justify-center transition-all focus-visible:ring-2 focus-visible:ring-forest-500 outline-none"
                ...
                <Tooltip content="Notifications">
                  <button
                    ...
                    className="w-10 h-10 lg:w-12 lg:h-12 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:text-white flex items-center justify-center transition-all relative focus-visible:ring-2 focus-visible:ring-forest-500 outline-none"

        ...
        return (
          <React.Fragment key={idx}>
            ...
            {isLast || !crumb.path ? (
              ...
              <Link
                to={crumb.path}
                className="hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-forest-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded"
              >
                {crumb.label}
              </Link>
            )}

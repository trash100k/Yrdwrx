              ...
              <div className="space-y-4 text-sm text-zinc-300 leading-relaxed font-medium mb-8">
                  ...
                  <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                      ...
                      <p className="text-amber-500/80 mb-3">
                          While CuttyOS builds the drafts, <strong>you are ultimately responsible for the content sent to your clients.</strong> By proceeding, you agree that you will manually review and approve every email generated by the system before it is dispatched outward.
                      </p>
                  ...
                  <p className="text-xs text-zinc-500">
                      Gaelworx AI and CuttyOS are not liable for lost profits, damaged reputation, CAN-SPAM violations, or hallucinations resulting from automated communications. You stand as the final human-in-the-loop and accept full responsibility for all approved outbound communications.
                  </p>
              </div>

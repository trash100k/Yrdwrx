  ...
  const verbatimSections = [
    {
      ...
      text: "We collect personal information that you provide to us when you register for CuttyOS, brought to market by Solano Resources, but all intellectual property and data controls are owned exclusively by Gaelworx AI. For owners, this includes business details, billing information, and operational metrics. For contractors, this includes location data during shifts and performance logs. For clients, this includes property metrics and communication histories. We also automatically collect telemetry such as IP addresses and device usage data. In accordance with Google API policies, this application is strictly prohibited for individuals under the age of 18, and we do not knowingly collect any data from minors.",
    },
    {
      title: "2. How We Use Information",
      text: "Gaelworx AI uses the information we collect to operate, maintain, and provide the features of CuttyOS. Your data may be used to deliver targeted notifications to clients, improve algorithmic scheduling for contractors, and train localized heuristics for the owner's tenant environment. You, the user, are strictly prohibited from using any AI-generated output from CuttyOS to develop or train competing large language models. While we do not sell any personally identifiable data, we may aggregate and anonymize backend operational capabilities and usage metadata. This completely anonymized data may be commercialized or sold by Gaelworx AI in compliance with standard legal processes to improve broader industry analytics and heuristics.",
    },
    {

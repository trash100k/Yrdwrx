...
export default function TermsOfService() {
  ...
  const summaryCards = [
    ...
    },
    {
      ...
      desc: "We are all honest business operators. No using the system for malicious attempts, scraping, reverse-engineering our software, or trying to jailbreak the YardWorx AI model. Play by the rules (no bypassing AI safety filters or doing illegal stuff), and we will protect your workspace.",
    },
    {
  ...
  const verbatimSections = [
    {
      ...
      text: "By accessing or using the YardWorx (a product brought to market by Gaelworx AI and owned by Gaelworx AI), you agree to be bound by these Terms of Service. This applies collectively to you as the business owner, your authorized contractors/employees utilizing the field application, and your clients utilizing the client portal. YardWorx provides a business operations software solution for field service professionals. Note: To comply with regional infrastructure costs and Google API policies, users operating within Europe, the United Kingdom (UK), or Switzerland are strictly required to use a paid billing tier.",
    },
    {

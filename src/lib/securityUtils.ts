...
export function isPrivateIP(ip: string): boolean {
  ...
  // IPv4-mapped IPv6 (::ffff:169.254.169.254 or ::ffff:7f00:1) — unwrap and re-check the embedded v4.
  ...
  if (ip === '::' || ip === '::1' || low.startsWith('fe80:') || low.startsWith('fc') || low.startsWith('fd')) {
    return true;
  }

...
files.forEach(file => {
  ...
  // Exact UI occurrences that we know are safe
  const specificReplacements = {
    'CuttyOS': 'YardWorx',
    'cuttyos': 'yardworx',
    'Cutty Copilot': 'YardPilot',
    'Cutty Chat': 'YardChat', // only the space version
    ...
    'CUTTY': 'YARDWORX',
    "demo@cutty.io": "demo@yardworx.io", // just to be safe if it's shown in UI
